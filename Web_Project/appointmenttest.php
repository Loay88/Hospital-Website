              ...
              <div class="row">
                  ...
                  <div class="col-md-4 col-sm-6">
                      <div class="form-group">
                          ...
                          <select class="form-control custom-select" id="Specialty" name="clinic_id">
<option value="14">Audiology</option>
<option value="31">Cardiology</option>
<option value="10">Dental Care</option>
...
<option value="8">Nutrition</option>
                  ...
                  <div class="col-md-4 col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control custom-select" id="Select Prefered Doctor" name="clinic_id">
<option value="100">Dr.Corrina Jonathon</option>
<option value="101">Dr.Jessica Mark</option>
<option value="102">Dr.Mark Antonios</option>
<option value="103">Dr.Antoine Reigns</option>
<option value="104">Dr.David Stones</option>
<option value="105">Dr.Fatima Ahmed</option>
<option value="106">Dr.Lionel Davies</option>
<option value="107">Dr.John Snow</option>
<option value="108">Dr.Nadia Dahmer</option>
</select>
                    </div>
                </div>
